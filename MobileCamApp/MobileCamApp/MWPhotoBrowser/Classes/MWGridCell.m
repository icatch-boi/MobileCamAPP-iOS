...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        UIImage *videoIndicatorImage = [UIImage imageForResourcePath:@"MWPhotoBrowser.bundle/images/VideoOverlay" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]];
        ...
        [_selectedButton setImage:[UIImage imageForResourcePath:@"MWPhotoBrowser.bundle/images/ImageSelectedSmallOff" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] forState:UIControlStateNormal];
        [_selectedButton setImage:[UIImage imageForResourcePath:@"MWPhotoBrowser.bundle/images/ImageSelectedSmallOn" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] forState:UIControlStateSelected];
...
//    _imageView.image = [_photo underlyingImage];
    ...
    _imageView.image = [self imageWithImage:image scaledToSize:CGSizeMake(image.size.width/25, image.size.height/25)];
